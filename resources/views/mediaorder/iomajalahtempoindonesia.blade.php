...
<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Input Order Majalah Tempo Indonesia :') }} {{ $k_order }}
        </h2>
    </x-slot>
...
<div class="container">
    <div class="flex flex-row">
                ...
                <div class="mb-3 xl:w-96">
                    ...
                    <input
                      ...
                      class="tarif form-control block w-full px-2 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300
                        rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        name="tarif" id="tarif" placeholder="Masukkan Tarif" readonly="readonly"/>
                </div>
            </div>
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    ...
                    <input
                      ...
                      class="form-control block w-full px-2 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300
                        rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        name="tarif_jasa" id="tarif_jasa" placeholder="Masukkan Jumlah Eksemplar" readonly="readonly"/>
                </div>
            </div>
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    ...
                    <input
                      ...
                      class="form-control block w-full px-2 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300
                        rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        name="brutto" id="brutto" placeholder="Masukkan Brutto" readonly="readonly"/>
                </div>
            </div>
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    ...
                    <input
                      ...
                      class="form-control block w-full px-2 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300
                        rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        id="netto" name="netto" placeholder="Masukkan Netto" readonly="readonly"/>
                </div>
            </div>
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    ...
                    <input
                      ...
                      class="form-control block w-full px-2 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300
                        rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        name="ppn" id="ppn" placeholder="PPN 11%" readonly="readonly"/>
                </div>
            </div>
                ...
                <div class="mb-3 xl:w-96">
                    ...
                    <input
                      ...
                      class="tagihan form-control block w-full px-2 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300
                        rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        name="tagihan" id="tagihan" placeholder="Tagihan" readonly="readonly"/>
                </div>
            </div>
        ...
        <input type="hidden" id="jenis_kontrak" name="jenis_kontrak" value="{{ $jenis_kontrak }}"/>
        <input type="hidden" id="jbarter" name="jbarter" value="{{ $jbarter }}"/>
        ...
        <input type="hidden" id="user_input" name="user_input" value="{{ Auth::user()->name }}"/>
        ...
        <table class="min-w-full text-center">
          ...
          <tbody>
            ...
            <tr class="bg-white border-b">
              ...
              <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                <a href="javascript:void(0)" id="btn-detail-omtimbm" data-id="{{ $iklanmbm->no_kwt }}"
...
@include('mediaorder.components.detailordermajalahtimbm')
...
<script>
  ...
  //action save order
  $('#saveordermajalahtempombm').click(function(e) {
    e.preventDefault();

    let opt_diskon_dalam = $('#opt_diskon_dalam').val();
    if(opt_diskon_dalam == 'idr'){
      var discr_in = 0;
      var discp_in = $('#diskon_dalam').val();
    }
    if(opt_diskon_dalam == 'persen'){
      var discr_in = $('#diskon_dalam').val();
      var discp_in = 0;
    }

    let opt_diskon_luar = $('#opt_diskon_luar').val();
    if(opt_diskon_luar == 'idr'){
      var discr_out = 0;
      var discp_out = $('#diskon_luar').val();
    }
    if(opt_diskon_luar == 'persen'){
      var discr_out = $('#diskon_luar').val();
      var discp_out = 0;
    }
    ...
    let k_edisi = $('#no_edisi').val();
    let tgl_terbit = $("#no_edisi option:selected").attr("class");
    let k_jenis = $('#jenis_iklan').val();
    let k_tarif = $('#layout_majalah').val();
    let k_jasa = $('#jasa_produksi').val();
    let hrg_tarif = $('#tarif').val();
    let jml_eks = $('#jml_eksemplar').val();
    let hrg_jasa = $('#tarif_jasa').val();
    let nharga = $('#brutto').val();
    let neto = $('#netto').val();
    let ppnp = 11;
    let ppnr = $('#ppn').val();
    let ttagih = $('#tagihan').val();
    let catatan = $('textarea#keterangan').val();
    ...
    $.ajax({
      ...
      url: `/mediaorder/saveorder`,
            ...
            success:function(response){
              ...
              $('input[name="opt_diskon_luar"]').prop('checked', false);  
              $('#tarif').val('');
              $('#jml_eksemplar').val('');
              $('#tarif_jasa').val('');
              $('#brutto').val('');
