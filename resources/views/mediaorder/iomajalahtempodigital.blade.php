...
<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Input Order Majalah Tempo Digital :') }} {{ $k_order }}
        </h2>
    </x-slot>
    ...
    <div class="flex flex-row">
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    ...
                    <select
                      ...
                      <option>Cara Bayar 1</option>
                      <option>Cara Bayar 2</option>
                      <option>Cara Bayar 3</option>
                    </select>
                </div>
            </div>
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    ...
                    <select
                      ...
                      placeholder="Pilih Biro"
                      id="k_biro">
                      <option selected>Pilih Edisi</option>
                      <option>Edisi 1</option>
                      <option>Edisi 2</option>
                      <option>Edisi 3</option>
                    </select>
                </div>
            </div>
        ...
        <div class="basis-2/3">
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    <label
                      for="no_kontrak" class="form-label inline-block mb-2 text-gray-700 text-sm ml-0 mr-9">
                      Jenis Transaksi :
                    </label>
                    ...
                    <label class="form-check-label inline-block text-gray-800 text-sm mr-4" for="inlineRadio10">Non Barter</label>
                    ...
                    <label class="form-check-label inline-block text-gray-800 text-sm mr-4" for="inlineRadio20">Barter</label>
                </div>
            </div>
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    ...
                    <select
                      ...
                      placeholder="Pilih Biro"
                      id="k_biro">
                      <option selected>Jenis Barter</option>
                    </select>
                </div>
            </div>
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    ...
                    <select
                      ...
                      placeholder="Pilih Biro"
                      id="k_biro">
                      <option selected>Pilih No. Edisi</option>
                    </select>
                </div>
            </div>
                ...
                <div class="mb-3 xl:w-96">
                    ...
                    <input
                      ...
                      class="form-control block w-full px-2 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300
                        rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        id="no_kontrak"
                      placeholder="Nominal Diskon Dalam"/>
                </div>
            </div>
                ...
                <div class="mb-3 xl:w-96">
                    ...
                    <input
                      ...
                      class="form-control block w-full px-2 py-1 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300
                        rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        id="no_kontrak"
                      placeholder="Nominal Diskon Luar"/>
                </div>
            </div>
