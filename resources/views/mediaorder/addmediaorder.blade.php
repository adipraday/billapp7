        ...
        <div class="basis-1/2">
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    <label
                      for="pilih_pt" class="form-label inline-block mb-2 text-gray-700 text-sm">
                      Pilih Perusahaan
                    </label>
                    <select
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96" id="jenis_kontrak">
                    ...
                    <div class="form-check mr-5">
                        ...
                        type="radio" id="jenis_kontrak" name="jenis_kontrak" value="N" >
                    ...
                    <div class="form-check">
                        <input class="form-check-input appearance-none rounded-full h-4 w-4 focus:outline-none 
                        transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" 
                        type="radio" id="jenis_kontrak" name="jenis_kontrak" value="B">
                        <label class="form-check-label inline-block text-gray-800" for="jenis_kontrak">
                        Barter
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input appearance-none rounded-full h-4 w-4 focus:outline-none 
                        transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" 
                        type="radio" id="jenis_kontrak" name="jenis_kontrak" value="S">
                        <label class="form-check-label inline-block text-gray-800" for="jenis_kontrak">
                        Barter & Non Barter
                        </label>
                    </div>
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96" id="status_ppn">
                    ...
                    <div class="form-check mr-5">
                        <input class="form-check-input appearance-none rounded-full h-4 w-4 focus:outline-none 
                        transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" 
                        type="radio" name="status_ppn" id="status_ppn" value="1">
                        <label class="form-check-label inline-block text-gray-800" for="status_ppn">Termasuk PPN</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input appearance-none rounded-full h-4 w-4 focus:outline-none 
                        transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" 
                        type="radio" name="status_ppn" id="status_ppn" value="0">
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96" id="atasnama">
                    ...
                    <div class="form-check mr-5">
                        <input class="form-check-input appearance-none rounded-full h-4 w-4 focus:outline-none 
                        transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" 
                        type="radio" name="atasnama" id="atasnama" value="B">
                        <label class="form-check-label inline-block text-gray-800" for="atasnama">Biro</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input appearance-none rounded-full h-4 w-4 focus:outline-none 
                        transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" 
                        type="radio" name="atasnama" id="atasnama" value="K">
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96" id="flag_paket">
                    ...
                    <div class="form-check mr-5">
                        <input class="form-check-input appearance-none rounded-full h-4 w-4 focus:outline-none 
                        transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" 
                        type="radio" name="flag_paket" id="flag_paket" value="1">
                        <label class="form-check-label inline-block text-gray-800" for="flag_paket">Yes</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input appearance-none rounded-full h-4 w-4 focus:outline-none 
                        transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" 
                        type="radio" name="flag_paket" id="flag_paket" value="0">
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96" id="flag_pktnoseri">
                    ...
                    <div class="form-check mr-5">
                        <input class="form-check-input appearance-none rounded-full h-4 w-4 focus:outline-none 
                        transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" 
                        type="radio" name="flag_pktnoseri" id="flag_pktnoseri" value="*">
            ...
            <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                    <label
                      ...
                      User Input oleh <b>{{ Auth::user()->name; }}</b>
                    </label>
...
<div class="container">
    <h6 class="font-medium leading-tight text-base">Last Media Order Record...</h6>
...
<script>
    ...
    $('#store').click(function(e) {
        ...
        let flag_paket = $("input[name='flag_paket']:checked").val();
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                $('#k_klien').val('');
                $('#nilai').val('');
                $('input[name="jenis_kontrak"]').prop('checked', false);
                $('#jbarter').val('');
                $('input[name="status_ppn"]').prop('checked', false);
                $('#nilai_nonbarter').val('');
                $('#nilai_barter').val('');
                $('#nilai_ppn').val('');
                $('#nilai_real').val('');
                $('input[name="atasnama"]').prop('checked', false);
                $('#k_sproduk').val('');
                $('#k_grup').val('');
                $('#k_indus').val('');
                $('#k_sales').val('');
                $('input[name="flag_paket"]').prop('checked', false);
                $('input[name="flag_pktnoseri"]').prop('checked', false);
                location.reload();
